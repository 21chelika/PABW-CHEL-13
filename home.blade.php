...
<head>
  ...
  <script>"https://code.jquery.com/jquery-3.4.1.js"</script>
...
<body>
  <header class="bg-[#F5FBFC;]">
    <nav class="container relative flex py-5 items-center justify-between">
      ...
      <div class="flex flex-col mt-2 mr-5">
        @auth
            <a href="{{ url('profile.edit') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Profile</a>
                @else
